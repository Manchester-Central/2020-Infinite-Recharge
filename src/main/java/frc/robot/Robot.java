...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        if (macAddress.equals(RobotConstantsRaft.MAC_ADDRESS)) {
            ...
            hardware = RobotType.chaos2020;
            DriverStation.reportWarning("Unrecognized MAC address, loading 2020 configuration", false);
        }

        if (hardware != RobotType.chaos2020) {
            DriverStation.reportWarning("NOT CONFIGURED FOR 2020 ROBOT", false);
        }
        ...
        if (hardware == RobotType.chaos2020) {
            ...
            intake = new Intake();
        } else if (hardware == RobotType.chaos2019) {
        ...
        } else if (hardware == RobotType.raft) {
            trackWidth = 26;
            flywheel = new DummyFlywheel();
            turret = new DummyTurret();
            navx = new DummyNavX();
            ...
            unjammer = new DummyUnjammer();
            intake = new DummyIntake();
        } else if (hardware == RobotType.simulator) {
            trackWidth = 26;
            flywheel = new DummyFlywheel();
            turret = new DummyTurret();
            navx = new DummyNavX();
    ...
    public void robotPeriodic() {
        ...
        // turret.smartDashboardConstants();
        // SmartDashboard.putBoolean("Limit Switch on?",
        // climbTake.getLimitSwitchState());
