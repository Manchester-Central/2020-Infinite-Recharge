...
import frc.robot.subsystems.serializer.DummySerializer;
import frc.robot.subsystems.serializer.ISerializer;
...
public class Robot extends TimedRobot {
    ...
    public static DummyTurret turret;
    ...
    public void robotInit() {
        ...
        serializer = new DummySerializer(hardware);

        if (hardware == RobotType.chaos2020) {
            turret = new DummyTurret(hardware);
